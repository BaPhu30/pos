...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::post('/import-purchase-products', 'BuySellController@importPurchaseProducts');
    Route::post('/buysell/update-status', 'BuySellController@updateStatus');
    Route::get('/buysell/get_products', 'BuySellController@getProducts');
    Route::get('/buysell/get_suppliers', 'BuySellController@getSuppliers');
    Route::post('/buysell/get_purchase_entry_row', 'BuySellController@getPurchaseEntryRow');
    Route::post('/buysell/check_ref_number', 'BuySellController@checkRefNumber');
    Route::get('/buysell/contacts', 'BuySellController@getContacts');
    Route::resource('buysell', 'BuySellController')->except(['show']);
