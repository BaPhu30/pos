...
<section class="content-header">
  <h1>@lang( 'business.add_business_location' )</h1>
</section>
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="col-sm-6">
        <div class="form-group">
          {!! Form::label('location_id', __( 'lang_v1.location_id' ) . ':') !!} @show_tooltip(__('lang_v1.leave_empty_to_autogenerate'))
      ...
      <div class="clearfix"></div>
      <div class="col-sm-6 gu-hide">
        <div class="form-group">
          {!! Form::label('invoice_scheme_id', __('invoice.invoice_scheme') . ':*') !!} @show_tooltip(__('tooltip.invoice_scheme'))
          {!! Form::select('invoice_scheme_id', $invoice_schemes, ['class' => 'form-control', 'required', 'placeholder' => __('messages.please_select')]); !!}
        </div>
      </div>
      <div class="col-sm-6 gu-hide">
        <div class="form-group">
          {!! Form::label('invoice_layout_id', __('lang_v1.invoice_layout_for_pos') . ':*') !!} @show_tooltip(__('tooltip.invoice_layout'))
          {!! Form::select('invoice_layout_id', $invoice_layouts, ['class' => 'form-control', 'required', 'placeholder' => __('messages.please_select')]); !!}
        </div>
      </div>
      <div class="clearfix"></div>
      <div class="col-sm-6 gu-hide">
        <div class="form-group">
          ...
          {!! Form::select('sale_invoice_layout_id', $invoice_layouts, ['class' => 'form-control', 'required', 'placeholder' => __('messages.please_select')]); !!}
        </div>
      </div>
      <div class="col-sm-6 gu-hide">
        <div class="form-group">
