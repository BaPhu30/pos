...
<section class="content">
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="form-group">
        ...
        {!! Form::text('weight_all', $product->weight_all, ['class' => 'form-control', 'placeholder' => __('product.weight_all'), 'required']); !!}
      </div>
    </div>
    <div class="col-sm-4">
      <div class="form-group">
        {!! Form::label('weight_jewel', __('product.weight_jewel') . ':*') !!}
        {!! Form::text('weight_jewel', $product->weight_jewel, ['class' => 'form-control', 'placeholder' => __('product.weight_jewel')]); !!}
      </div>
    </div>
    <div class="col-sm-4">
      <div class="form-group">
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="form-group">
        {!! Form::label('import_price', __('product.import_price') . ':') !!} @show_tooltip(__('product.import_price_help'))
        {!! Form::text('import_price', $product->wage_buy, ['class' => 'form-control', 'placeholder' => __('product.import_price')]); !!}
      </div>
    </div>
    <div class="col-sm-4">
      <div class="form-group">
        {!! Form::label('export_price', __('product.export_price') . ':') !!} @show_tooltip(__('product.export_price_help'))
        {!! Form::text('export_price', $product->wage_sell, ['class' => 'form-control', 'placeholder' => __('product.export_price')]); !!}
      </div>
    </div>
    <div class="col-sm-4">
      <div class="form-group">
