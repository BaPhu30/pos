  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      <div class="row">
        <div class="col-md-4">
          <div class="form-group">
            ...
            {!! Form::text('name', $product_name, ['class' => 'form-control', 'required', 'placeholder' => __('product.product_name')]); !!}
          </div>
        </div>
        <div class="col-sm-4">
          <div class="form-group">
      ...
      <div class="row">
        <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('weight_all', __('product.weight_all') . ':*') !!} @show_tooltip(__('product.weight_all_help'))
            {!! Form::text('weight_all', null, ['class' => 'form-control', 'placeholder' => __('product.weight_all'), 'required']); !!}
          </div>
        </div>
        <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('weight_jewel', __('product.weight_jewel') . ':*') !!}
            {!! Form::text('weight_jewel', null, ['class' => 'form-control', 'placeholder' => __('product.weight_jewel')]); !!}
          </div>
        </div>
        <div class="col-sm-4">
          <div class="form-group">
      ...
      <div class="row">
        <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('wage_buy', __('product.wage_buy') . ':') !!} @show_tooltip(__('product.wage_buy_help'))
            {!! Form::text('wage_buy', null, ['class' => 'form-control', 'placeholder' => __('product.wage_buy')]); !!}
          </div>
        </div>
        <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('wage_sell', __('product.wage_sell') . ':') !!} @show_tooltip(__('product.wage_sell_help'))
            {!! Form::text('wage_sell', null, ['class' => 'form-control', 'placeholder' => __('product.wage_sell')]); !!}
          </div>
        </div>
        <div class="col-sm-4">
          <div class="form-group">
      ...
      <div class="row">
        ...
        <div class="col-sm-4" id="alert_quantity_div">
          <div class="form-group">
            ...
            {!! Form::text('alert_quantity', null, ['class' => 'form-control input_number', 'placeholder' => __('product.alert_quantity'), 'min' => '0']); !!}
          </div>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-sm-4">
          <div class="form-group">
            <label>
              {!! Form::checkbox('enable_sr_no', 1, false, ['class' => 'input-icheck']); !!} <strong>@lang('lang_v1.enable_imei_or_sr_no')</strong> @show_tooltip(__('lang_v1.tooltip_sr_no'))
            </label>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="form-group">
            <label>
              {!! Form::checkbox('not_for_selling', 1, false, ['class' => 'input-icheck']); !!} <strong>@lang('lang_v1.not_for_selling')</strong> @show_tooltip(__('lang_v1.tooltip_not_for_selling'))
            </label>
          </div>
        </div>
        <div class="clearfix"></div>
