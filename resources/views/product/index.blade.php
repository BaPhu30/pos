...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    {!! Form::label('active_state', __('messages.actions') . ':') !!}
    ...
    $(document).ready(function() {
        product_table = $('#product_table').DataTable({
            ...
            columns: [{
                ...
                {
                    data: 'weight_all',
                    name: 'products.weight_all'
                },
                {
                    data: 'weight_jewel',
                    name: 'products.weight_jewel'
                },
                {
                    data: 'wage_buy',
            ...
            if (!data_table_initailized) {
                ...
                stock_report_table = $('#stock_report_table').DataTable({
                    ...
                    "footerCallback": function(row, data, start, end, display) {
                        ...
                        $('.footer_total_stock').html(__product_trans_from_en(footer_total_stock, false));
                        // $('.footer_total_stock_price').html(__currency_trans_from_en(total_stock_price));
                        $('.footer_total_stock_price').html('');
                        $('.footer_total_sold').html(__product_trans_from_en(footer_total_sold, false));
                        $('.footer_total_transfered').html(__product_trans_from_en(footer_total_transfered, false));
                        $('.footer_total_adjusted').html(__product_trans_from_en(total_adjusted, false));
                        ...
                        if ($('th.current_stock_mfg').length) {
                            $('.footer_total_mfg_stock').html(__product_trans_from_en(footer_total_mfg_stock, false));
                        }
                    },
                });
