...
<section class="content">
  ...
  <div class="row">
      ...
      <div class="user_auth_fields @if(empty($user->allow_login)) hide @endif">
        <div class="col-md-4">
          <div class="form-group">
            ...
            {!! Form::text('username', $user->username, ['class' => 'form-control', 'placeholder' => __( 'business.username' ) ]); !!}
            @endif
            <p class="help-block">@lang('lang_v1.username_edit_help')</p>
          </div>
        </div>
        <div class="col-md-4">
          <div class="form-group">
    ...
    <div class="col-md-12">
      @component('components.widget', ['title' => __('lang_v1.cmmsn_percent')])
      <div class="col-md-4">
        <div class="form-group">
      ...
      <div class="clearfix"></div>
      <div class="col-sm-4 hide selected_contacts_div @if(!$user->selected_contacts) @endif">
        <div class="form-group">
