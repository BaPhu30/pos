...
<section class="content">
	...
	{!! Form::open(['url' => action('BuySellController@store'), 'method' => 'post', 'id' => 'add_buy_sell_form', 'files' => true ]) !!}

	@component('components.widget', ['class' => 'box-primary'])
	<div class="row">
		<div class="col-sm-3">
			<div class="form-group">
				{!! Form::label('location_id', __('buysell.business_location').':*') !!} @show_tooltip(__('buysell.business_location_help'))
		...
		<div class="col-sm-3">
			<div class="form-group">
				{!! Form::label('contact_id', __('buysell.customers') . ':*') !!}
		...
		<div class="col-sm-3">
			<div class="form-group">
				{!! Form::label('transaction_date', __('buysell.transaction_date') . ':*') !!}
				<div class="input-group">
					<span class="input-group-addon">
		...
		<div class="col-sm-3">
			<div class="form-group">
				{!! Form::label('bill_no', __('buysell.bill_no').':') !!} @show_tooltip(__('buysell.leave_empty_to_autogenerate'))
	...
	<div class="row">
		<div class="col-sm-3 @if(!empty($default_purchase_status)) hide @endif">
			<div class="form-group">
				{!! Form::label('status', __('buysell.transaction_status') . ':*') !!} @show_tooltip(__('tooltip.order_status'))
