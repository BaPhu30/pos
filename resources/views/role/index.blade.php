...
<section class="content-header">
    <h1>@lang( 'role.roles' )
        <small>@lang( 'role.manage_roles' )</small>
    </h1>
    <!-- <ol class="breadcrumb">
...
<section class="content">
    @component('components.widget', ['class' => 'box-primary', 'title' => __( 'role.all_roles' )])
    @can('roles.create')
    @slot('tool')
    <div class="box-tools">
        <a class="btn btn-block btn-primary" href="{{ action('RoleController@create') }}"><i class="fa fa-plus"></i> @lang( 'messages.add' )</a>
    </div>
    @endslot
    @endcan
    @can('roles.view')
